...
public class MPluginSecretPlayerListener implements Listener {
	...
	public void onPlayerChat(AsyncPlayerChatEvent event) {
        ...
        format = format.replace(Conf.chatTagReplaceString, SavageFactionsPlugin.plugin.getPlayerFactionTag(speaker)).replace("[FACTION_TITLE]", SavageFactionsPlugin.plugin.getPlayerTitle(speaker));
