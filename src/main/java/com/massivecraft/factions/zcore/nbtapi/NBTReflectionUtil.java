...
import com.massivecraft.factions.zcore.nbtapi.utils.JacksonWrapper;
...
public class NBTReflectionUtil {
	...
	public static void setObject(NBTCompound comp, String key, Object value) {
		...
		try {
			String json = JacksonWrapper.getString(value);
	...
	public static <T> T getObject(NBTCompound comp, String key, Class<T> type) {
		...
		return json != null ? JacksonWrapper.deserializeJson(json, type) : null;
	}
