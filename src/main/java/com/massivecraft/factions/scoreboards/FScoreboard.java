...
public class FScoreboard {
	...
	public void setDefaultSidebar(final FSidebarProvider provider, int updateInterval) {
		...
		}.runTaskTimer(SavageFactionsPlugin.plugin, updateInterval, updateInterval);
	}
	...
	public void setTemporarySidebar(final FSidebarProvider provider) {
		...
		}.runTaskLater(SavageFactionsPlugin.plugin, SavageFactionsPlugin.plugin.getConfig().getInt("scoreboard.expiration", 7) * 20);
	}
