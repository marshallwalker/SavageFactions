...
public class LocationTypeAdapter implements JsonSerializer<Location>, JsonDeserializer<Location> {
	...
	public JsonElement serialize(Location location, Type type, JsonSerializationContext jsonSerializationContext) {
		...
		try {
			...
			ex.printStackTrace();
			SavageFactionsPlugin.plugin.log(Level.WARNING, "Error encountered while serializing a Location.");
			return object;
		}
	}
	...
	public Location deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) {
		...
		try {
			...
			ex.printStackTrace();
			SavageFactionsPlugin.plugin.log(Level.WARNING, "Error encountered while" +
