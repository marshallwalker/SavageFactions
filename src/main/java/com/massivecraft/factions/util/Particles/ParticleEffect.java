...
public enum ParticleEffect {
	...
	// Initialize map for quick name and uniqueId lookup
	static {
	...
	/**
	 * Returns the particle effect with the given uniqueId
	 *
	...
	private static boolean isWater(Location location) {
		...
		return material == Material.WATER || material == SavageFactionsPlugin.plugin.STATIONARY_WATER;
	}
	...
	/**
	 * Returns the uniqueId of this particle effect
	 *
	 * @return The uniqueId
	 */
	public int getId() {
	...
	public static final class NoteColor extends ParticleColor {
		 ...
		 *
		 * @param note Note uniqueId which determines color
