...
public class CmdList extends FCommand {
	...
	public void perform() {
		...
		if (!payForCommand(Conf.econCostList, TL.COMMAND_LIST_TOLIST, TL.COMMAND_LIST_FORLIST))
			return;
		...
		if (fme != null && fme.getPlayer() != null && !fme.getPlayer().hasPermission("factions.show.bypassexempt")) {
			List<String> exemptFactions = SavageFactionsPlugin.plugin.getConfig().getStringList("show-exempt");
