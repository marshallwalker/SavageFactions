...
public class CmdCreate extends FCommand {
	...
	public void perform() {
		...
		FactionCreateEvent createEvent = new FactionCreateEvent(fme, tag);
		...
		Faction faction = Factions.getInstance().createFaction(tag);
		...
		if (SavageFactionsPlugin.plugin.getConfig().getBoolean("faction-creation-broadcast", true)) {
		...
		if (Conf.logFactionCreate) {
			SavageFactionsPlugin.plugin.log(fme.getName() + TL.COMMAND_CREATE_CREATEDLOG.toString() + tag);
		}
