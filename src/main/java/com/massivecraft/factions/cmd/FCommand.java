...
public abstract class FCommand extends MCommand<SavageFactionsPlugin> {
    ...
    public FCommand() {
        super(SavageFactionsPlugin.plugin);
    ...
    public boolean isEnabled() {
        ...
        if (this.isMoneyCommand && !bankConfiguration.enabled) {
    ...
    public Faction strAsFaction(String name, Faction def, boolean msg) {
        ...
        if (name != null) {
            ...
            Faction faction = Factions.getInstance().getFactionByTag(name); // Checks for faction name match.
            ...
            if (faction == null) {
                faction = Factions.getInstance().getFactionByBestTagMatch(name);
            }
    ...
    public boolean payForCommand(double cost, String toDoThis, String forDoingThis) {
        ...
        if (bankConfiguration.enabled && bankConfiguration.factionPaysCosts && fme.hasFaction()) {
    ...
    public void doWarmUp(WarmUpUtil.Warmup warmup, TL translationKey, String action, Runnable runnable, long delay) {
        doWarmUp(fme, warmup, translationKey, action, runnable, delay);
    }
